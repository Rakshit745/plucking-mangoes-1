...
chain=new Chain(stoneObj.body,{x:150,y:450})
...
function mouseReleased()
  {
    chain.released();
   Matter.Body.applyForce(stoneObj.body,stoneObj.body.position,{x:50,y:-200});
  }
...
function keyPressed()
{
  if(keyCode == space)
  {
      Matter.Body.setPosition(stoneObj,{x:100,y:400});
